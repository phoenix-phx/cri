...
function addItemInv(){
    ...
    inp.innerHTML = " - ";
    inp.id = 'bICI' + i; inp.className="button";
    const lol = "" + i;
...
function Select(index){
    ...
    divi.appendChild(document.createElement("br"));
    let txtInp = document.createElement("select");
    txtInp.id = "uniInvSCI" + index; txtInp.name = "uniInvSCI" + index;
    txtInp.innerHTML = '<option value="">Ninguno</option>' + 
    '<option value="Familia y Comunidad">Familia y Comunidad</option>' + 
    '<option value="Etica y moral">&Eacute;tica y moral</option>' +
    '<option value="Desarrollo humano integral: Derechos humanos, salud y educacion">Desarrollo humano integral: Derechos humanos, salud y educación</option>' +
...
function addItemAct(){
    ...
    inp = ndivi.appendChild(document.createElement("button"));
    inp.innerHTML = " - "; inp.className="button";
    inp.id = 'bA' + actividad;
    const lul = "" + actividad;
...
function existFinan(){
    ...
    inp.name = "obsTipoFOCI"; inp.id = "obsTipoFOCI"; inp.rows = "4"; inp.cols = "100"; inp.className="textInput";
    d.appendChild(document.createElement("br"));
}
